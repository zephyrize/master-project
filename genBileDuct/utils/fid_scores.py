...
class fid_pytorch():
    def __init__(self, dataloader_val):
        self.dims = 2048
        ...
        self.name = 'bile_duct'
        self.no_EMA = noEMA
        self.path_to_save = os.path.join(self.checkpoints_dir, self.name, "FID")
    ...
    def update(self, model, cur_iter):
        ...
        cur_fid = self.compute_fid_with_valid_path(model.module.netG, None if self.no_EMA is True else model.module.netEMA)
