...
class BackBone(nn.Module):
    ...
    def __init__(self, in_ch, out_ch, img_size, sample_slices=3, patch_size=16, embed_dim=384, attention_heads=12, block_nums=[4,4,4,4]) -> None:
...
def get_Unet_ATM_V9(img_size, dsv=False, sample_slices=3):
...
if __name__ == '__main__':
    ...
    model = get_Unet_ATM_V9(256, False, 3)
