...
基于AATM V4 的 自注意力改进版本

在此版本中，轴注意力不再基于自注意力机制

q,k,v重新定义为：

q1 = lower slice.repeat(3)
q2 = upper slice.repeat(3)

k = v = [lower, mid, upper]

attention map = softMax(q1, k) + softMax(q2, k)
...
def get_Unet_AATM_V7(img_size, dsv=False):
