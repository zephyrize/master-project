...
from preprocessor_V1 import Preprocessor
...
# 对比实验模型测试
# 如果需要保存预测结果，在命令后面加入 --save_infer，如果需要保存后处理结果，加入 --postprocess
# 如果需要将结果存入csv文件，请加入命令 --save_csv

# UNet 2D
# python -W ignore test.py --model Unet --model_remark 2d --best --gpu 1 --sample_slices 1

# UNet 2.5D
# python -W ignore test.py --model Unet --model_remark dice --best --gpu 1

# UNet 3D
# lsx代跑3D代码，只有预测结果

# AttUnet
# python -W ignore test.py --model AttUnet --model_remark dice --best --gpu 1

# Unet++
# python -W ignore test.py --model NestedUnet --model_remark dice --best --gpu 1

# transUnet
# python -W ignore test.py --model offical_transUnet --model_remark dice --best --gpu 1

# Mnet
# python -W ignore test.py --model MNet --model_remark dice --best --gpu 1

# SATr
# python -W ignore test.py --model Unet_SATR --model_remark dice --best --gpu 1
# Cat

# python -W ignore test.py --model Cat --batch_size 16 --best --gpu 1
...
# Base + ASPP = UnetASPP
# python -W ignore test.py --model UnetASPP --model_remark aspp --best --gpu 1

# Base + SATM = AATM_V4
# python -W ignore test.py --model AATM_V4 --model_remark dice --best --gpu 1

# Base + SATM = ATM_V3 该模型找不到嘞，有一次不小心把模型都删除了，发现ATM_V3的模型没有备份。。。
# 

# Base+SATM+ASPP+SGC Loss = ATM_V9
# python -W ignore test.py --model ATM_V9 --model_remark dice_consistency_dot_5 --best --gpu 1
