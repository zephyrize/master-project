...
class TestSegmentationNetwork():
    def __init__(self, test_dataset, crop_size, segmentation_model, use_gpu=True, save_path='',
    ...
    def evaluate(self, i: int, data_tensor_pack: dict, total_number: int, maximum_batch_size=4):
        '''
        :param i: id
